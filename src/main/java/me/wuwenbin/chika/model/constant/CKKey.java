...
import static me.wuwenbin.chika.model.constant.CKValue.*;
...
public enum CKKey {
     ...
     * 页脚的文字
     */
    WEBSITE_TITLE(CKValue.WEBSITE_TITLE.val(), MID.intVal(), "网站标题"),
    WEBSITE_LOGO_WORDS(CKValue.WEBSITE_LOGO_WORDS.val(), MID.intVal(), "网站的LOGO文字"),
    WEBSITE_LOGO_SMALL_WORDS(CKValue.WEBSITE_LOGO_SMALL_WORDS.val(), MID.intVal(), "网站LOGO旁的小字"),
    FOOTER_WORDS(CKValue.FOOTER_WORDS.val(), MID.intVal(), "页脚的文字"),
     ...
     * 留言页面顶部的文字
     */
    INDEX_TOP_WORDS(CKValue.INDEX_TOP_WORDS.val(), MID.intVal(), "首页顶部的一些文字"),
    COMMENT_TOP_NOTICE(CKValue.COMMENT_TOP_NOTICE.val(), MID.intVal(), "评论面板上方的公告"),
    PROJECT_TOP_WORDS(CKValue.PROJECT_TOP_WORDS.val(), MID.intVal(), "项目页面顶部的文字"),
    MESSAGE_TOP_NOTICE(CKValue.MESSAGE_TOP_NOTICE.val(), MID.intVal(), "留言页面顶部的文字"),
     ...
     * 导航栏功能菜单相关设置
     */
    MENU_HOME_NAME(CKValue.MENU_HOME_NAME.val(), MID.intVal(), StrUtil.EMPTY),
    MENU_HOME_ONOFF(ENABLE.val(), MID.intVal(), StrUtil.EMPTY),

    MENU_NOTE_NAME(CKValue.MENU_NOTE_NAME.val(), MID.intVal(), StrUtil.EMPTY),
    ...
    MENU_LINK_ONFF(CKValue.DISABLE.val(), MID.intVal(), StrUtil.EMPTY),

    MENU_PROJECT_NAME(CKValue.MENU_PROJECT_NAME.val(), MID.intVal(), StrUtil.EMPTY),
    MENU_PROJECT_ONOFF(CKValue.DISABLE.val(), MID.intVal(), StrUtil.EMPTY),

    MENU_FILE_NAME(CKValue.MENU_FILE_NAME.val(), MID.intVal(), StrUtil.EMPTY),
    MENU_FILE_ONFF(CKValue.DISABLE.val(), MID.intVal(), StrUtil.EMPTY),

    MENU_PROFILE_NAME(CKValue.MENU_PROFILE_NAME.val(), MID.intVal(), StrUtil.EMPTY),
    MENU_PROFILE_ONOFF(CKValue.DISABLE.val(), MID.intVal(), StrUtil.EMPTY),

    MENU_SEARCH_NAME(CKValue.MENU_SEARCH_NAME.val(), MID.intVal(), StrUtil.EMPTY),
    MENU_SEARCH_ONOFF(CKValue.DISABLE.val(), MID.intVal(), StrUtil.EMPTY),
     ...
     * 上传类型（七牛还是本地）
     */
    INFO_LABEL_CONTENT(CKValue.INFO_LABEL_CONTENT.val(), MID.intVal(), "信息板内容"),
    ...
    COMMENT_LENGTH(CKValue.COMMENT_LENGTH.val(), MID.intVal(), "评论文字长度"),
    ...
    CKKey(Object val, int level, String desc) {
        this.val = val;
        this.level = level;
        this.desc = desc;
    }
